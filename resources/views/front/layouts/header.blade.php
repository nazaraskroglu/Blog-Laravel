...
<html lang="tr">
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="{{asset($config->favicon)}}" style="width:50px;height: 40px" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{route('homepage')}}">
                  <img src="{{asset($config->logo)}}" style="width:160px;height: 95px" />
                </a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('@yield('bg',asset('front/assets/img/ark1.jpg'))')">
